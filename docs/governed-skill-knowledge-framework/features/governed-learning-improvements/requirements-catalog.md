...
| REQ-GLI-08 | Provide a VS Code/GovKB freshness check. | AC6 | A-6 | UC-7 | Planned for Phase 4 |
| REQ-GLI-09 | Keep existing public commands backward compatible. | AC7 | A-7 | UC-1 through UC-7 | Passed in Phase 0 regression |
